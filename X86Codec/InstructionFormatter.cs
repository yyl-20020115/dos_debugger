...
public class InstructionFormatter
{
    ...
    public virtual string FormatOperand(Operand operand) => operand switch
    {
        ImmediateOperand => FormatOperand((ImmediateOperand)operand),
        RegisterOperand => FormatOperand((RegisterOperand)operand),
        MemoryOperand => FormatOperand((MemoryOperand)operand),
        RelativeOperand => FormatOperand((RelativeOperand)operand),
        PointerOperand => FormatOperand((PointerOperand)operand),
        _ => throw new ArgumentException("Unsupported operand type.")
    };
