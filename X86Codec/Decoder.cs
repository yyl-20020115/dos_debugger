 ...
 */
    ...
    {
        /* 00 */ new (Operation.ADD, O.Eb, O.Gb),
        /* 01 */ new (Operation.ADD, O.Ev, O.Gv),
        /* 02 */ new (Operation.ADD, O.Gb, O.Eb),
        /* 03 */ new (Operation.ADD, O.Gv, O.Ev),
        /* 04 */ new (Operation.ADD, O.AL, O.Ib),
        /* 05 */ new (Operation.ADD, O.rAX, O.Iz),
        /* 06 */ new (Operation.PUSH, O.ES), /* i64 */
        /* 07 */ new (Operation.POP, O.ES),  /* i64 */
        /* 08 */ new (Operation.OR, O.Eb, O.Gb),
        /* 09 */ new (Operation.OR, O.Ev, O.Gv),
        /* 0A */ new (Operation.OR, O.Gb, O.Eb),
        /* 0B */ new (Operation.OR, O.Gv, O.Ev),
        /* 0C */ new (Operation.OR, O.AL, O.Ib),
        /* 0D */ new (Operation.OR, O.rAX, O.Iz),
        /* 0E */ new (Operation.PUSH, O.CS), /* i64 */
        /* 0F */ Op.Empty,      /* 2-byte escape */

        /* 10 */ new (Operation.ADC, O.Eb, O.Gb),
        /* 11 */ new (Operation.ADC, O.Ev, O.Gv),
        /* 12 */ new (Operation.ADC, O.Gb, O.Eb),
        /* 13 */ new (Operation.ADC, O.Gv, O.Ev),
        /* 14 */ new (Operation.ADC, O.AL, O.Ib),
        /* 15 */ new (Operation.ADC, O.rAX, O.Iz),
        /* 16 */ new (Operation.PUSH, O.SS), /* i64 */
        /* 17 */ new (Operation.POP, O.SS), /* i64 */
        /* 18 */ new (Operation.SBB, O.Eb, O.Gb),
        /* 19 */ new (Operation.SBB, O.Ev, O.Gv),
        /* 1A */ new (Operation.SBB, O.Gb, O.Eb),
        /* 1B */ new (Operation.SBB, O.Gv, O.Ev),
        /* 1C */ new (Operation.SBB, O.AL, O.Ib),
        /* 1D */ new (Operation.SBB, O.rAX, O.Iz),
        /* 1E */ new (Operation.PUSH, O.DS), /* i64 */
        /* 1F */ new (Operation.POP, O.DS), /* i64 */

        /* 20 */ new (Operation.AND, O.Eb, O.Gb),
        /* 21 */ new (Operation.AND, O.Ev, O.Gv),
        /* 22 */ new (Operation.AND, O.Gb, O.Eb),
        /* 23 */ new (Operation.AND, O.Gv, O.Ev),
        /* 24 */ new (Operation.AND, O.AL, O.Ib),
        /* 25 */ new (Operation.AND, O.rAX, O.Iz),
        /* 26 */ Op.Empty, /* SEG=ES (prefix) */
        /* 27 */ new (Operation.DAA), /* i64 */
        /* 28 */ new (Operation.SUB, O.Eb, O.Gb),
        /* 29 */ new (Operation.SUB, O.Ev, O.Gv),
        /* 2A */ new (Operation.SUB, O.Gb, O.Eb),
        /* 2B */ new (Operation.SUB, O.Gv, O.Ev),
        /* 2C */ new (Operation.SUB, O.AL, O.Ib),
        /* 2D */ new (Operation.SUB, O.rAX, O.Iz),
        /* 2E */ Op.Empty, /* SEG=CS (prefix) */
        /* 2F */ new (Operation.DAS), /* i64 */

        /* 30 */ new (Operation.XOR, O.Eb, O.Gb),
        /* 31 */ new (Operation.XOR, O.Ev, O.Gv),
        /* 32 */ new (Operation.XOR, O.Gb, O.Eb),
        /* 33 */ new (Operation.XOR, O.Gv, O.Ev),
        /* 34 */ new (Operation.XOR, O.AL, O.Ib),
        /* 35 */ new (Operation.XOR, O.rAX, O.Iz),
        /* 36 */ Op.Empty, /* SEG=SS (prefix) */
        /* 37 */ new (Operation.AAA), /* i64 */
        /* 38 */ new (Operation.CMP, O.Eb, O.Gb),
        /* 39 */ new (Operation.CMP, O.Ev, O.Gv),
        /* 3A */ new (Operation.CMP, O.Gb, O.Eb),
        /* 3B */ new (Operation.CMP, O.Gv, O.Ev),
        /* 3C */ new (Operation.CMP, O.AL, O.Ib),
        /* 3D */ new (Operation.CMP, O.rAX, O.Iz),
        /* 3E */ Op.Empty, /* SEG=DS (prefix) */
        /* 3F */ new (Operation.AAS), /* i64 */

        /* 40 */ new (Operation.INC, O.eAX), /* i64, O.REX */
        /* 41 */ new (Operation.INC, O.eCX), /* i64, O.REX.B */
        /* 42 */ new (Operation.INC, O.eDX), /* i64, O.REX.X */
        /* 43 */ new (Operation.INC, O.eBX), /* i64, O.REX.XB */
        /* 44 */ new (Operation.INC, O.eSP), /* i64, O.REX.R */
        /* 45 */ new (Operation.INC, O.eBP), /* i64, O.REX.RB */
        /* 46 */ new (Operation.INC, O.eSI), /* i64, O.REX.RX */
        /* 47 */ new (Operation.INC, O.eDI), /* i64, O.REX.RXB */
        /* 48 */ new (Operation.DEC, O.eAX), /* i64, O.REX.W */
        /* 49 */ new (Operation.DEC, O.eCX), /* i64, O.REX.WB */
        /* 4A */ new (Operation.DEC, O.eDX), /* i64, O.REX.WX */
        /* 4B */ new (Operation.DEC, O.eBX), /* i64, O.REX.WXB */
        /* 4C */ new (Operation.DEC, O.eSP), /* i64, O.REX.WR */
        /* 4D */ new (Operation.DEC, O.eBP), /* i64, O.REX.WRB */
        /* 4E */ new (Operation.DEC, O.eSI), /* i64, O.REX.WRX */
        /* 4F */ new (Operation.DEC, O.eDI), /* i64, O.REX.WRXB */

        /* 50 */ new (Operation.PUSH, O.rAX), /* d64 */
        /* 51 */ new (Operation.PUSH, O.rCX), /* d64 */
        /* 52 */ new (Operation.PUSH, O.rDX), /* d64 */
        /* 53 */ new (Operation.PUSH, O.rBX), /* d64 */
        /* 54 */ new (Operation.PUSH, O.rSP), /* d64 */
        /* 55 */ new (Operation.PUSH, O.rBP), /* d64 */
        /* 56 */ new (Operation.PUSH, O.rSI), /* d64 */
        /* 57 */ new (Operation.PUSH, O.rDI), /* d64 */
        /* 58 */ new (Operation.POP, O.rAX), /* d64 */
        /* 59 */ new (Operation.POP, O.rCX), /* d64 */
        /* 5A */ new (Operation.POP, O.rDX), /* d64 */
        /* 5B */ new (Operation.POP, O.rBX), /* d64 */
        /* 5C */ new (Operation.POP, O.rSP), /* d64 */
        /* 5D */ new (Operation.POP, O.rBP), /* d64 */
        /* 5E */ new (Operation.POP, O.rSI), /* d64 */
        /* 5F */ new (Operation.POP, O.rDI), /* d64 */
        
        /* 60 */ new (Operation.PUSHA), /* i64 */
        /* 61 */ new (Operation.POPA), /* i64 */
        /* 62 */ new (Operation.BOUND, O.Gv, O.Ma), /* i64 */
        /* 63 */ new (Operation.ARPL, O.Ew, O.Gw), /* i64, O.MOVSXD (o64) */
        /* 64 */ Op.Empty, /* SEG=FS (prefix) */
        /* 65 */ Op.Empty, /* SEG=GS (prefix) */
        /* 66 */ Op.Empty, /* operand size (prefix) */
        /* 67 */ Op.Empty, /* address size (prefix) */
        /* 68 */ new (Operation.PUSH, O.Iz), /* d64 */
        /* 69 */ new (Operation.IMUL3, O.Gv, O.Ev, O.Iz),
        /* 6A */ new (Operation.PUSH, O.Ib), /* d64 */
        /* 6B */ new (Operation.IMUL3, O.Gv, O.Ev, O.Ib),
        /* 6C */ new (Operation.INS, O.Yb, O.DX),
        /* 6D */ new (Operation.INS, O.Yz, O.DX),
        /* 6E */ new (Operation.OUTS, O.DX, O.Xb),
        /* 6F */ new (Operation.OUTS, O.DX, O.Xz),


        /* f64 - The operand size is forced to a 64-bit operand size
         * when in 64-bit mode, O.regardless of size prefix. 
         */
        /* 70 */ new (Operation.JO, O.Jb),
        /* 71 */ new (Operation.JNO, O.Jb),
        /* 72 */ new (Operation.JB, O.Jb),
        /* 73 */ new (Operation.JAE, O.Jb),
        /* 74 */ new (Operation.JE, O.Jb),
        /* 75 */ new (Operation.JNE, O.Jb),
        /* 76 */ new (Operation.JBE, O.Jb),
        /* 77 */ new (Operation.JA, O.Jb),
        /* 78 */ new (Operation.JS, O.Jb),
        /* 79 */ new (Operation.JNS, O.Jb),
        /* 7A */ new (Operation.JP, O.Jb),
        /* 7B */ new (Operation.JNP, O.Jb),
        /* 7C */ new (Operation.JL, O.Jb),
        /* 7D */ new (Operation.JGE, O.Jb),
        /* 7E */ new (Operation.JLE, O.Jb),
        /* 7F */ new (Operation.JG, O.Jb),

        /* 80 */ new (OpcodeExtension.Ext1, O.Eb, O.Ib),
        /* 81 */ new (OpcodeExtension.Ext1, O.Ev, O.Iz),
        /* 82 */ new (OpcodeExtension.Ext1, O.Eb, O.Ib), /* i64 ??? TBD */
        /* 83 */ new (OpcodeExtension.Ext1, O.Ev, O.Ib),
        /* 84 */ new (Operation.TEST, O.Eb, O.Gb),
        /* 85 */ new (Operation.TEST, O.Ev, O.Gv),
        /* 86 */ new (Operation.XCHG, O.Eb, O.Gb),
        /* 87 */ new (Operation.XCHG, O.Ev, O.Gv),
        /* 88 */ new (Operation.MOV, O.Eb, O.Gb),
        /* 89 */ new (Operation.MOV, O.Ev, O.Gv),
        /* 8A */ new (Operation.MOV, O.Gb, O.Eb),
        /* 8B */ new (Operation.MOV, O.Gv, O.Ev),
        /* 8C */ new (Operation.MOV, O.Ev, O.Sw),
        /* 8D */ new (Operation.LEA, O.Gv, O.M_), /* ??? missing TBD */
        /* 8E */ new (Operation.MOV, O.Sw, O.Ew),
        /* 8F */ new (OpcodeExtension.Ext1A), /* POP(d64) Ev */

        /* 90 */ new (Operation.NOP), /* PAUSE (F3), O.XCHG r8, O.rAX */
        /* 91 */ new (Operation.XCHG, O.rCX, O.rAX),
        /* 92 */ new (Operation.XCHG, O.rDX, O.rAX),
        /* 93 */ new (Operation.XCHG, O.rBX, O.rAX),
        /* 94 */ new (Operation.XCHG, O.rSP, O.rAX),
        /* 95 */ new (Operation.XCHG, O.rBP, O.rAX),
        /* 96 */ new (Operation.XCHG, O.rSI, O.rAX),
        /* 97 */ new (Operation.XCHG, O.rDI, O.rAX),
        /* 98 */ new (Operation.CBW), /* CWDE/CDQE */
        /* 99 */ new (Operation.CWD), /* CDQ/CQO */
        /* 9A */ new (Operation.CALLF, O.Ap), /* i64 */
        /* 9B */ new (Operation.FWAIT), /* WAIT */
        /* 9C */ new (Operation.PUSHF, O.Fv), /* PUSHF/D/Q(d64) */
        /* 9D */ new (Operation.POPF, O.Fv), /* POPF/D/Q(d64) */
        /* 9E */ new (Operation.SAHF),
        /* 9F */ new (Operation.LAHF),

        /* A0 */ new (Operation.MOV, O.AL, O.Ob),
        /* A1 */ new (Operation.MOV, O.rAX, O.Ov),
        /* A2 */ new (Operation.MOV, O.Ob, O.AL),
        /* A3 */ new (Operation.MOV, O.Ov, O.rAX),
        /* A4 */ new (Operation.MOVSB, O.Yb, O.Xb),
        /* A5 */ new (Operation.MOVSW, O.Yv, O.Xv), /* MOVSW/D/Q */
        /* A6 */ new (Operation.CMPSB, O.Xb, O.Yb),
        /* A7 */ new (Operation.CMPSW, O.Xv, O.Yv), /* CMPSW/D/Q */
        /* A8 */ new (Operation.TEST, O.AL, O.Ib),
        /* A9 */ new (Operation.TEST, O.rAX, O.Iz),
        /* AA */ new (Operation.STOSB, O.Yb, O.AL),
        /* AB */ new (Operation.STOSW, O.Yv, O.rAX), /* STOSW/D/Q */
        /* AC */ new (Operation.LODSB, O.AL, O.Xb),
        /* AD */ new (Operation.LODSW, O.rAX, O.Xv), /* LODSW/D/Q */
        /* AE */ new (Operation.SCASB, O.AL, O.Yb),
        /* AF */ new (Operation.SCASW, O.rAX, O.Xv), /* SCASW/D/Q */

        /* B0 */ new (Operation.MOV, O.AL, O.Ib),
        /* B1 */ new (Operation.MOV, O.CL, O.Ib),
        /* B2 */ new (Operation.MOV, O.DL, O.Ib),
        /* B3 */ new (Operation.MOV, O.BL, O.Ib),
        /* B4 */ new (Operation.MOV, O.AH, O.Ib),
        /* B5 */ new (Operation.MOV, O.CH, O.Ib),
        /* B6 */ new (Operation.MOV, O.DH, O.Ib),
        /* B7 */ new (Operation.MOV, O.BH, O.Ib),
        /* B8 */ new (Operation.MOV, O.rAX, O.Iv),
        /* B9 */ new (Operation.MOV, O.rCX, O.Iv),
        /* BA */ new (Operation.MOV, O.rDX, O.Iv),
        /* BB */ new (Operation.MOV, O.rBX, O.Iv),
        /* BC */ new (Operation.MOV, O.rSP, O.Iv),
        /* BD */ new (Operation.MOV, O.rBP, O.Iv),
        /* BE */ new (Operation.MOV, O.rSI, O.Iv),
        /* BF */ new (Operation.MOV, O.rDI, O.Iv),

        /* C0 */ new (OpcodeExtension.Ext2,  O.Eb, O.Ib),
        /* C1 */ new (OpcodeExtension.Ext2,  O.Ev, O.Ib),
        /* C2 */ new (Operation.RET, O.Iw), /* f64 */
        /* C3 */ new (Operation.RET),       /* f64 */
        /* C4 */ new (Operation.LES, O.Gz, O.Mp), /* i64; VEX+2byte */
        /* C5 */ new (Operation.LDS, O.Gz, O.Mp), /* i64; VEX+1byte */
        /* C6 */ new (OpcodeExtension.Ext11, O.Eb, O.Ib),
        /* C7 */ new (OpcodeExtension.Ext11, O.Ev, O.Iz),
        /* C8 */ new (Operation.ENTER, O.Iw, O.Ib),
        /* C9 */ new (Operation.LEAVE), /* d64 */
        /* CA */ new (Operation.RETF, O.Iw),
        /* CB */ new (Operation.RETF),
        /* CC */ new (Operation.INT, O.Imm3),
        /* CD */ new (Operation.INT, O.Ib),
        /* CE */ new (Operation.INTO), /* i64 */
        /* CF */ new (Operation.IRET), /* IRET/D/Q */

        /* D0 */ new (OpcodeExtension.Ext2, O.Eb, O.Imm1),
        /* D1 */ new (OpcodeExtension.Ext2, O.Ev, O.Imm1),
        /* D2 */ new (OpcodeExtension.Ext2, O.Eb, O.CL),
        /* D3 */ new (OpcodeExtension.Ext2, O.Ev, O.CL),
        /* D4 */ new (Operation.AAM, O.Ib), /* i64 */
        /* D5 */ new (Operation.AAD, O.Ib), /* i64 */
        /* D6 */ Op.Empty,
        /* D7 */ new (Operation.XLATB, O._XLAT),
        /* D8 */ new (OpcodeExtension.Fpu),
        /* D9 */ new (OpcodeExtension.Fpu),
        /* DA */ new (OpcodeExtension.Fpu),
        /* DB */ new (OpcodeExtension.Fpu),
        /* DC */ new (OpcodeExtension.Fpu),
        /* DD */ new (OpcodeExtension.Fpu),
        /* DE */ new (OpcodeExtension.Fpu),
        /* DF */ new (OpcodeExtension.Fpu),

        /* E0 */ new (Operation.LOOPNZ, O.Jb), /* f64 */
        /* E1 */ new (Operation.LOOPZ, O.Jb), /* f64 */
        /* E2 */ new (Operation.LOOP, O.Jb), /* f64 */
        /* E3 */ new (Operation.JCXZ, O.Jb), /* f64; JrCXZ */
        /* E4 */ new (Operation.INB, O.AL, O.Ib),
        /* E5 */ new (Operation.INW, O.eAX, O.Ib),
        /* E6 */ new (Operation.OUTB, O.Ib, O.AL),
        /* E7 */ new (Operation.OUTW, O.Ib, O.eAX),
        /* E8 */ new (Operation.CALL, O.Jz), /* f64 */
        /* E9 */ new (Operation.JMP, O.Jz), /* near, O.f64 */
        /* EA */ new (Operation.JMPF, O.Ap), /* far, O.i64 */
        /* EB */ new (Operation.JMP, O.Jb), /* short, O.f64 */
        /* EC */ new (Operation.INB, O.AL, O.DX),
        /* ED */ new (Operation.INW, O.eAX, O.DX),
        /* EE */ new (Operation.OUTB, O.DX, O.AL),
        /* EF */ new (Operation.OUTW, O.DX, O.eAX),

        /* F0 */ Op.Empty, /* LOCK (prefix) */
        /* F1 */ Op.Empty,
        /* F2 */ Op.Empty, /* REPNE (prefix) */
        /* F3 */ Op.Empty, /* REPE (prefix) */
        /* F4 */ new (Operation.HLT),
        /* F5 */ new (Operation.CMC),
        /* F6 */ new (OpcodeExtension.Ext3, O.Eb),
        /* F7 */ new (OpcodeExtension.Ext3, O.Ev),
        /* F8 */ new (Operation.CLC),
        /* F9 */ new (Operation.STC),
        /* FA */ new (Operation.CLI),
        /* FB */ new (Operation.STI),
        /* FC */ new (Operation.CLD),
        /* FD */ new (Operation.STD),
        /* FE */ new (OpcodeExtension.Ext4), /* INC/DEC */
        /* FF */ new (OpcodeExtension.Ext5)  /* INC/DEC */
    };

    public enum OpcodeExtension : int
    {
        None = 0,
        Ext1,
        Ext1A,
